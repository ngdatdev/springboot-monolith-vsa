...
public class GetProductInventoryService implements IService<GetProductInventoryRequest, GetProductInventoryResponse> {

    private final GetProductInventoryRepository repository;

    @Override
    @Transactional(readOnly = true)
    public GetProductInventoryResponse execute(GetProductInventoryRequest request) {
        ...
        return GetProductInventoryResponse.builder()
